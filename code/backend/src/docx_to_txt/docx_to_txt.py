...
import os
import docx2txt
from .domain_errors import NonDirectoryDE, NonFileDE
            ...
            if os.path.isdir(subdir_full):
                ...
                for fname in sorted(os.listdir(subdir_full)):
                    ...
                    if os.path.isfile(file_full):
                        ...
                        raise NonFileDE(f"Expected file but found directory: {file_full}")
            else:
                raise NonDirectoryDE(f"non-directory: {subdir_full}")
